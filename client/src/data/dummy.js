...
export const InformationData = [
    ...
    contents: [
      {
        title: "What is SIP?",
        content:
          "SIP is a popular investment method where investors can regularly invest a fixed amount at periodic intervals.",
      },
      {
        title: "Why SIP?",
        content:
      ...
      {
        title: "Flexibility of Investing in SIPs",
        content:
          "SIPs offer flexibility to investors. Investors can choose the investment amount, frequency (monthly, quarterly, etc.), and the duration of the investment based on their financial goals and risk appetite.",
      },
      {
      ...
      {
        title: "Benefits of SIP Calculator",
        content:
  ...
  },
  {
    ...
    contents: [
      ...
      {
        title: "10 in 20-10-4 Rule?",
        content:
          "The rule suggests limiting the EMI amount to be less than 10% of your monthly income to achieve financial stability.",
      },
      {
        title: "Benefits Of 20-10-4 Rule",
        content:
      ...
      {
        title: "What is 20-10-4 Calculator?",
        content:
