...
//     try {
//       const { data } = await authFetch.get(`stockWatch/getOne/${params.sym}`);
//       if (data.success) {
//         setIsWatch(true);
//         setWatch(data.watch);
//       } else {
...
//   };
//   return (
//     <div className="m-2 md:m-10 mb-10 mt-24 md:mx-9 mx-2 p-2 md:p-6 dark:bg-secondary-dark-bg bg-white rounded-3xl text-center relative">
...
//         </div>
//         {!loading && (
//           <div className="absolute top-0 right-0 lg:m-8 m-5">
//             <button onClick={handleWatch}>
//               {isWatch && !watchLoading && (
//                 <AiFillHeart size={"30px"} color="red" className="m-auto" />
//               )}
//               {!isWatch && !watchLoading && (
//                 <AiOutlineHeart size={"30px"} color="red" className="m-auto" />
//               )}
//             </button>
//             {watchLoading && <RingLoader color={currentColor} size={"30px"} />}
//           </div>
//         )}
//         {loading ? (
